...
$loaded = []
require("test3-1.rb")
check([ "test3-1.rb", "test3-2.rb" ], $loaded, "Nested and recursive loaded check.")
...
begin
  ...
  exception = (e.class == LoadError)
end
check(true, exception, "LoadError should be raised if invalid file is passed to 'require'.")
...
$num = 0
load("test11.rb")
check(1000, $num, "Recursive loading check.")
